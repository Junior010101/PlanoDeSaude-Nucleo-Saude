...
def cpf():
    ...
    for chave, item in dados.items():
        ...
        if chave == cpf:
            ...
            print(f"{a}    {f'{chave:<15}{a}{item["nome"]:<22}│{item["sexo"]:<7}│{idade:<7}│{item["email"]:<30}│{data_n:<10}│{item["telefone"]:<13}│{item["plano_saude"]["plano"]:<12}│{item["plano_saude"]["valor"]:<10}│{data_v:<10}':<145}{a}")
